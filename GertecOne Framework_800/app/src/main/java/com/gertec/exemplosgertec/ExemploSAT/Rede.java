...
public class Rede extends Activity {
    ...
    private String appPackage = "com.gertec.exemplosgertec";
            ...
            public void onClick(View arg0) {
                try {
                    if (txtCodAtivacao.getText().toString().length() >= 8) {
                        ...
                        String resp = satLib.enviarConfRede(gerador.nextInt(999999), dadosXml, txtCodAtivacao.getText().toString());
                    ...
                    Toast.makeText(Rede.this, e.getMessage().toString(), Toast.LENGTH_LONG).show();
                }
            }
        });
    }
    ...
    public void dialogoRetorno(String s) {
        ...
        try {
            // Inicia o Alert
            AlertDialog.Builder builder = new AlertDialog.Builder(Rede.this);
            //define o titulo
